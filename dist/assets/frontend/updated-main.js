...
/***/ "./assets/scss/updated_payment_fields.scss":
/*!*************************************************!*\
  !*** ./assets/scss/updated_payment_fields.scss ***!
  \*************************************************/
...
(() => {
/*!***********************************!*\
  !*** ./assets/js/updated-main.js ***!
  \***********************************/
__webpack_require__(/*! ./assets/scss/updated_payment_fields.scss */ "./assets/scss/updated_payment_fields.scss");
...
window.initPaytrail = () => {
  const paytrailToggleView = () => {
    ...
    var toggleBtn = document.querySelector(".paytrail-bank-dropdown__toggle-btn");
    var expandedContainer = document.getElementById("paytrail-bank-expanded");
    var collapsedText = document.querySelector(".paytrail-bank-dropdown__text");
    ...
    if (expandedContainer.classList.contains("hidden")) {
      ...
      if (collapsedChildren && collapsedChildren.classList.contains("paytrail-bank-dropdown__providers")) {
...
/******/ })()
;
//# sourceMappingURL=updated-main.js.map